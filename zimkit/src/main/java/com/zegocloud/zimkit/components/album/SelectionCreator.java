package com.zegocloud.zimkit.components.album;
...
import com.zegocloud.zimkit.components.album.engine.ImageEngine;
import com.zegocloud.zimkit.components.album.engine.impl.GlideEngine;
import com.zegocloud.zimkit.components.album.engine.impl.PicassoEngine;
import com.zegocloud.zimkit.components.album.filter.Filter;
import com.zegocloud.zimkit.components.album.internal.entity.CaptureStrategy;
import com.zegocloud.zimkit.components.album.internal.entity.SelectionSpec;
import com.zegocloud.zimkit.components.album.listener.OnCheckedListener;
import com.zegocloud.zimkit.components.album.listener.OnSelectedListener;
import com.zegocloud.zimkit.components.album.ui.MatisseActivity;
...
public final class SelectionCreator {
     ...
     * 1. im.zego.zimkitalbum.R.style.Matisse_default;
     * 2. im.zego.zimkitalbum.R.style.Matisse_Dracula
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is im.zego.zimkitalbum.R.style.Matisse_default.
     * @return {@link SelectionCreator} for fluent API.
     */
    ...
    /**
     *  Maximum original size,the unit is MB.Set the maximum number of images that can be selected
     * @param size The maximum image size. The default value is Integer.MAX_VALUE.
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator maxImageSize(int size) {
        mSelectionSpec.imageMaxSize = size;
        return this;
    }

    /**
     *  Maximum original size,the unit is MB.Set the maximum number of video that can be selected
     * @param size The maximum video size. The default value is Integer.MAX_VALUE.
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator maxVideoSize(int size) {
        mSelectionSpec.videoMaxSize = size;
        return this;
    }

package com.zegocloud.zimkit.components.album.browserimage.view;
...
public class BrowserProcessView extends FrameLayout {
    ...
    private void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.zimkit_album_view_process, this, true);

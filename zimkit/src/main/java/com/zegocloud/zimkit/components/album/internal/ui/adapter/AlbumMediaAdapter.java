package com.zegocloud.zimkit.components.album.internal.ui.adapter;
...
import com.zegocloud.zimkit.components.album.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.zimkit_item_media_grid, parent, false);

...
public class FileIconUtils {
    ...
    public static int queryFileIcon(String path) {
        if (TextUtils.isEmpty(path)) {
            return R.mipmap.zimkit_icon_file_unsure;
        }
        return queryFileIcon(path, R.mipmap.zimkit_icon_file_unsure);
    }
    ...
    public static int queryFileIcon(String path, int defaultIconId) {
        int iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_excel, excelArray);
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_compressed, zipArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_word, wordArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_ppt, pptArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_pdf, pdfArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_txt, txtArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_audio, audioArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_video, videoArray);
        }
        if (iconId == 0) {
            iconId = compareEndWith(path, R.mipmap.zimkit_icon_file_image, imageArray);
        }
        if (iconId == 0) {
            // Use default icon

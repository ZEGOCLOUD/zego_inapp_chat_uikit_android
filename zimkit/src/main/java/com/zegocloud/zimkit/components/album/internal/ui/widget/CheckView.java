package com.zegocloud.zimkit.components.album.internal.ui.widget;
...
public class CheckView extends View {
    ...
    private static final float BG_RADIUS = 11.8f; // dp
    ...
    private void init(Context context) {
        ...
        int defaultColor = ResourcesCompat.getColor(
                getResources(), R.color.default_item_checkCircle_borderColor,
                getContext().getTheme());
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.zimkit_icon_check_white_18dp, context.getTheme());
    }
    ...
    private void initTextPaint() {
        if (mTextPaint == null) {
            ...
            mTextPaint.setTextSize(14.0f * mDensity);
        }
    }

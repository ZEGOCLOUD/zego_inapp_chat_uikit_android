...
import im.zego.zimkitmessages.databinding.MessageLayoutInputBinding;
import im.zego.zimkitmessages.fragment.ZIMKitEmojiFragment;
import im.zego.zimkitmessages.fragment.ZIMKitInputMoreFragment;
import im.zego.zimkitmessages.model.ZIMKitEmojiItemModel;
import im.zego.zimkitmessages.model.ZIMKitInputModel;
...
public class ZIMKitInputView extends LinearLayout {
    ...
    private MessageLayoutInputBinding mBinding;
    ...
    private void initView(Context context) {
        ...
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.message_layout_input, this, true);
    ...
    private void initListener() {
        ...
        mBinding.btnEmoji.setOnClickListener(v -> {
            ...
            mBinding.btnEmoji.setBackgroundResource(emojiStatus ? R.mipmap.message_ic_emoji_audio_show : R.mipmap.message_ic_emoji_close);
            ...
            if (emojiStatus) {
                ...
                showEmojiViewGroup();
                mBinding.btnAudio.setBackgroundResource(R.mipmap.message_ic_audio_close);
            } else {
                showSoftInput();
            }
        });
        ...
        mBinding.btnMore.setOnClickListener(v -> {
            ...
            if (moreStatus) {
                ...
                showInputMoreLayout();
                mBinding.btnEmoji.setBackgroundResource(R.mipmap.message_ic_emoji_close);
                mBinding.btnAudio.setBackgroundResource(R.mipmap.message_ic_audio_close);
            } else {
                showSoftInput();
            }
            ...
            PermissionHelper.onMicrophonePermissionGranted(mActivity, new PermissionHelper.GrantResult() {
                ...
                public void onGrantResult(boolean allGranted) {
                    if (allGranted) {
                        ...
                        mBinding.btnAudio.setBackgroundResource(audioStatus ? R.mipmap.message_ic_emoji_audio_show : R.mipmap.message_ic_audio_close);
                        mInputModel.fileClick(false);
                        mInputModel.emojiClick(false);
                        removeFragment();
                        if (audioStatus) {
                        ...
                        baseDialog.setMsgTitle(mActivity.getString(R.string.message_photo_no_mic_tip));
                        baseDialog.setMsgContent(mActivity.getString(R.string.message_photo_no_mic_description));
                        baseDialog.setLeftButtonContent(mActivity.getString(R.string.message_access_later));
                        baseDialog.setRightButtonContent(mActivity.getString(R.string.message_go_setting));
        ...
        mBinding.btnSend.setOnClickListener(v -> {
            ...
            if (inputMsg == null || inputMsg.trim().isEmpty()) {
                ZIMKitToastUtils.showToast(mActivity.getString(R.string.message_cant_send_empty_msg));
                return;
            }
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        mBinding.chatAudioInput.setText(mActivity.getString(R.string.message_audio_record_release_to_send));
                    ...
                    case MotionEvent.ACTION_MOVE:
                        if (motionEvent.getY() - mStartRecordY < -100) {
                            mAudioCancel = true;
                            mBinding.chatAudioInput.setText(mActivity.getString(R.string.message_audio_record_release_to_cancel));
                            if (mChatRecordHandler != null) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        mBinding.chatAudioInput.setText(mActivity.getString(R.string.message_audio_record_normal));
                        break;
                    default:
                        break;
                }

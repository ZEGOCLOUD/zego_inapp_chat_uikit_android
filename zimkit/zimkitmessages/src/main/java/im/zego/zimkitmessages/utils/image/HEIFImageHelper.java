...
public class HEIFImageHelper {
    ...
    public static synchronized String heifToJpg(String path) {
        ...
        String tempPath = ZIMKitManager.share().getApplication().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + File.separator + "images/" + System.currentTimeMillis() + "_zimkit" + suffix_jpg;

package im.zego.zimkitalbum.browserimage.download;
...
public class GlideDownloadHelper {
    ...
    private static class DownloadTaskImpl implements WorkTask, DownloadTask {
        ...
        public void download() throws InterruptedException, ExecutionException, IOException {
            ...
            GlideDownloadHelper.FileUtils.copy(originFile, targetFile);
            GlideDownloadHelper.FileUtils.deleteFile(originFile);
            if (isCancel) {
                return;
            }
            mainThread.post(() -> {

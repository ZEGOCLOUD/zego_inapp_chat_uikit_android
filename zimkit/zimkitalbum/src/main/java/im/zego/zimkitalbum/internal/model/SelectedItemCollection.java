package im.zego.zimkitalbum.internal.model;

import static im.zego.zimkitalbum.internal.entity.IncapableCause.TOAST_DIALOG;
...
import im.zego.zimkitalbum.internal.entity.IncapableCause;
import im.zego.zimkitalbum.internal.entity.Item;
import im.zego.zimkitalbum.internal.entity.SelectionSpec;
import im.zego.zimkitalbum.internal.ui.widget.CheckView;
...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        if (maxSelectableReached()) {
            ...
            return new IncapableCause(TOAST_DIALOG, cause);
        } else if (overFileSize(item)) {
            return new IncapableCause(TOAST_DIALOG, mContext.getString(R.string.album_over_size));

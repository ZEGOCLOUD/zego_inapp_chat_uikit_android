...
import im.zego.zimkitcommon.databinding.CommonLayoutProcessBinding;

public class ProcessView extends FrameLayout {

    private CommonLayoutProcessBinding mBinding;
    ...
    private void initView(Context context) {
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.common_layout_process, this, true);
    }
